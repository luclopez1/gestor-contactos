...
def index()
        ...
        tr
            ...
            td
                a href=eliminar{i} 
                   ...
                   style=color#e74c3c;text-decorationnone;font-weightbold
                   ✕ Eliminar
                a
            td
        tr
    ...
    head
        ...
        style
            ...
            inputfocus {{ border-color #2F75B6; }}
            ...
            trnth-child(even) td {{ background #f9fbff; }}
            trhover td {{ background #e8f0fe; }}
            ...
            .download-btnhover {{ background #1e7b34; }}
        style
    head
    body
        header
            h1Gestor de Contactosh1
            spanLos datos se guardan en contactos.xlsxspan
        header
        ...
        div class=container
            ...
            div class=card
                ...
                form method=POST action=añadir
                    div class=form-row
                        ...
                        div
                    div
                    button type=submit+ Añadir contactobutton
                form
            div
            ...
            div class=card
                h2
                    ...
                    {&nbsp;&nbsp;a href='descargar' class='download-btn'⬇ Descargar Excela if total  0 else }
                h2

                {tabletheadtrth#ththNombreththEmpresaththEmailththAcciónthtrtheadtbody + filas + tbodytable if total  0 else 'p class=emptyNo hay contactos todavía. Añade el primero arriba.p'}
            div
...
if __name__ == __main__
    inicializar_excel()
    print(n✅ Gestor de contactos iniciado.)
    print(   Abre tu navegador y ve a httplocalhost5000)
    print(   Pulsa Ctrl+C para cerrar.n)
    app.run(debug=False)